        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" method="post" action="{{ url('store/car') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="speed" class="form-control" id="exampleInputEmail1"
                         ...
                         <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="kilos" class="form-control" id="exampleInputEmail1"
