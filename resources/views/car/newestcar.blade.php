...
<body class="u-body u-overlap">
    ...
    <section class="u-align-left u-clearfix u-image u-section-2" id="carousel_2a21">
        <div class="u-clearfix u-sheet u-sheet-1">
            ...
            <h1 class="u-text u-text-body-alt-color u-text-2">Newest Cars</h1>
        </div>
    </section>
    @foreach ($cars as $car)
                        ...
                        <div class="u-layout-row">
                            <div
                                ...
                                <div class="u-container-layout u-valign-middle u-container-layout-1">
                                    ...
                                    <img src="{{ asset("uploads/$car->img") }}" class="u-align-left u-image u-image-1"
                                        data-image-width="900" data-image-height="540">
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <div class="u-container-layout u-valign-middle u-container-layout-2">
                                    ...
                                    <div class="mt-3">
                                        <div class="row">
                                            <div class="col-3 text-center" style="font-size: 30px;"><i
                                                    class="fa-solid fa-car"></i></div>
                                            <div class="col-9 pt-1" style="font-size: 20px;">Price:
                                                {{ $car->price }} </div>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-3 text-center" style="font-size: 30px;"><i
                                                    class="fa-solid fa-car-on"></i></div>
                                            <div class="col-9 pt-1" style="font-size: 20px;">model number:
                                                {{ $car->model_number }}</div>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <div class="row">
                                            ...
                                            <div class="col-9 pt-1" style="font-size: 20px;">kilos:
                                                {{ $car->kilos }} </div>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        <div class="row">
                                            <div class="col-3 text-center" style="font-size: 30px;"><i
                                                    class="fa-brands fa-stack-exchange"></i></div>
                                            <div class="col-9 pt-1" style="font-size: 20px;">fual tank:
                                                {{ $car->fual_tank }}</div>
                                        </div>
                                    </div>
                                    ...
                                    <a href="{{-- details/{{ $car->id }} --}} {{url('details',$car->id)}}"
